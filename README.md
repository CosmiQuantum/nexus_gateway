...
* **System configuration files** – Including `fstab`, `.k5login`, and related setup files
* **Alarm and monitoring code** – Scripts used for system health checks and alerts
...
* Virtual environments (`venv/`) and system-generated files are intentionally excluded
* Only source code, configuration, and reproducible setup components are tracked
